...
CREATE TABLE `elite` (
  ...
  `elite_year` int(11) DEFAULT NULL,
  KEY `FK557v8ekxx74wsnroogm4mfmnu` (`user_id`),
  CONSTRAINT `FK557v8ekxx74wsnroogm4mfmnu` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
