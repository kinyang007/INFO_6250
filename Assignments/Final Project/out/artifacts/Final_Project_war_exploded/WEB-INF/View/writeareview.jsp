...
<div class="jumbotron">
    <div class="container">
        ...
        <br/>
        <form method="post" action="/writeareview/search?page=1">
        ...
        <ul class="pagination">
            <c:choose>
                <c:when test="${currentPage > 1}">
                    <li class="page-item">
                        <a class="page-link" href="/writeareview/search?page=${currentPage - 1}">Previous</a>
                    </li>
                </c:when>
                <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${i == currentPage}">
                        <li class="page-item active">
                            <a class="page-link" href="/writeareview/search?page=${i}">${i}</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item">
            ...
            <c:choose>
                <c:when test="${currentPage < pageCount}">
                    <li class="page-item">
                        <a class="page-link" href="/writeareview/search?page=${currentPage + 1}">Next</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li class="page-item disabled">
