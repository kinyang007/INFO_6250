...
<div class="container">
    ...
    <br/>
    <div class="container">
        <form method="post" action="/business/${business.id}?page=1">
    ...
    <div class="container">
        ...
        <c:forEach var="review" items="${reviews}">
            <div class="row border border-top-0 border-left-0 border-right-0">
                <div class="col-sm-3">
                    <h6><b>User Name: </b>${review.user.name}</h6>
                    <p>
                        ${review.user.friends.size()} friends<br/>
    ...
    <ul class="pagination">
        <c:choose>
            <c:when test="${currentPage > 1}">
                <li class="page-item">
                    <a class="page-link" href="/business/${business.id}?page=${currentPage - 1}">Previous</a>
                </li>
            </c:when>
            <c:otherwise>
            ...
            <c:choose>
                <c:when test="${i == currentPage}">
                    <li class="page-item active">
                        <a class="page-link" href="/business/${business.id}?page=${i}">${i}</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li class="page-item">
        ...
        <c:choose>
            <c:when test="${currentPage < pageCount}">
                <li class="page-item">
                    <a class="page-link" href="/business/${business.id}?page=${currentPage + 1}">Next</a>
                </li>
            </c:when>
            <c:otherwise>
                <li class="page-item disabled">
